...
export default function Index() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      >
        <header className="flex items-center justify-between border-b border-white px-6 py-4 lg:flex-none">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative flex items-center rounded-md bg-white shadow-sm md:items-stretch">
              ...
              <Button
                slot={null}
                className="select-none items-center border-y border-gray-300  px-3.5 text-sm font-semibold text-gray-900 hover:bg-gray-50 focus:relative md:flex"
                onPress={() => {
        ...
        >
          ...
          <CalendarGridBody
            className={
              duration === "month"
                ? "grid flex-1 grid-rows-5 [&_tr]:grid [&_tr]:grid-cols-7 [&_tr]:divide-x [&_tr]:divide-zinc-200 [&_tr_>_td]:border-b [&_tr_>_td]:border-b-zinc-200"
                : duration === "week"
                  ...
                  {dayEvents.length > 0 && (
                    <ol className="mt-2">
                      ...
                      {dayEvents.length > 2 && duration === "month" && (
                        <DialogTrigger>
                          <Button slot={null} className="text-sm text-gray-500">
      ...
      >
        <Modal className="fixed bottom-[20%] left-[39%] right-[49%] top-[20%] w-96 ">
          <Dialog className="flex h-full w-full flex-col justify-center gap-4 bg-opacity-0 p-4 focus:outline-none">
            {({ close }) => (
              <div>
